...
namespace FabSet_Project.Controllers
{
    public class SignupController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,Username,Email,Password,Retype")] Signup signup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Username,Email,Password,Retype")] Signup signup)
        {
            if (id != signup.UserId)
            {
                return NotFound();
